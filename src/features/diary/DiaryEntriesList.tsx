      ...
      <ul>
        {entries.map((entry) => {
          ...
          return(  
            ...
            >
              <h1 style={{color:"red",fontWeight:"bold"}}>{entry.title}</h1>
              <hr></hr>
              <h1  style={{color:"blue",fontWeight:"bold"}}>DESCRIPTION</h1>
            <h3 style={{color:"orange",fontWeight:"bold"}}>{entry.content}</h3>
